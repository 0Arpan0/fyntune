...
function Landing() {
  ...
  return (
    <div className="d-flex flex-column align-items-center justify-content-center" style={{fontWeight:"bolder", fontFamily:"sans-serif"}}>
      <h1>Add Shop</h1>
      ...
      <div  className="d-flex flex-column align-items-center justify-content-center" style={{width:"320px"}}>
        {list.map((item) => {
          return (
            <div className="d-flex flex-column align-items-center justify-content-center" style={{ border: "1px solid black", width: "100%", marginTop:"10px" }}>
